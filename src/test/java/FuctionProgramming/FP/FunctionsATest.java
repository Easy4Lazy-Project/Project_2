...
public class FunctionsATest {
    ...
    public void searchTest(){
       ...
       // System.out.println( Functions.search.apply(usersList,"Search in Java"));

         List<Content> ret= Functions.search.apply(usersList,"Search in Java");

         String retS=   Functions.searchStrRegex.apply("Binary, Search, in Java we");

            Assert.assertEquals("Binary,|Search,|in|Java",retS);
        }
